...
export function HeroSection() {
  return (
    <section id="top" aria-labelledby="hero-headline">
      <Container className="pt-14 pb-12 text-center sm:pt-20 lg:pt-24 lg:pb-14">
        <Rise index={0}>
        ...
        <Rise index={1} y={22}>
          <h1
            id="hero-headline"
            className="mt-5 text-[34px] leading-[1.3] font-extrabold tracking-[-0.03em] sm:text-[44px] lg:text-[54px]"
          >
        ...
        <Rise index={2}>
          <p className="mt-3.5 font-script text-[21px] leading-tight text-faint sm:text-[25px]">
            {HERO.aside}
          </p>
        </Rise>

        <Rise index={3}>
          <p className="mx-auto mt-7 max-w-[600px] text-[16px] leading-[1.65] text-body sm:text-[17px]">
            {HERO.sub}
          </p>
        </Rise>
        ...
        <Rise
          index={4}
          y={22}
          className="mt-9 flex flex-col items-stretch justify-center gap-2.5 sm:flex-row sm:items-center sm:gap-3"
        >
        ...
        <Rise index={5} y={10}>
          <p className="mt-4.5 font-mono text-[11.5px] tracking-[0.06em] text-faint">
            {SITE.reassurance}
          </p>
        </Rise>
      </Container>
