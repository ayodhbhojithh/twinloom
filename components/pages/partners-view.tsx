    ...
    <>
      ...
      <section className="page-frame pt-10 pb-16">
        {/* What each one covers, as a wall that drifts past.
            ...
            nobody can read. */}
        <div className="group -mx-[calc(50vw-50%)] overflow-hidden px-[calc(50vw-50%)] py-3">
              ...
              >
                {DISCIPLINES.map((entry, index) => (
                  <article
                    ...
                    className="flex w-[clamp(260px,24vw,330px)] shrink-0 flex-col rounded-[20px] bg-field p-6 transition-transform duration-300 hover:-translate-y-1.5"
                  >
                    <span className="font-mono text-[10px] font-bold text-mark tabular-nums">
                      {entry.n}
                    </span>

                    <h2 className="mt-3 max-w-[18ch] text-[17px] leading-[1.2] font-extrabold tracking-[-0.028em] text-ink">
                      {entry.name}
                    </h2>
                    ...
                    <p className="mt-auto flex gap-2.5 pt-4 text-[12.5px] leading-[1.5] text-quiet">
                      <span
                        aria-hidden
