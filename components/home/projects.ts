...
export const PROJECTS: readonly Project[] = [
  ...
  {
    id: "charity",
    name: "A charity that explains itself",
    kind: "Giving",
    year: "2026",
    summary:
      "Where the money goes, said before it is asked for. One page of evidence, a giving journey that survives Gift Aid, and a way to give once or every month without two different forms.",
    facts: [
      { term: "Pages", value: "9" },
      { term: "Built in", value: "4 weeks" },
      { term: "Visitors", value: "Donors and trustees" },
    ],
    image: "/work-shop.png",
    alt: "A giving page with the case for support beside it.",
    tone: "#eceef2",
  },
  {
    id: "practice",
    name: "A practice that wins the brief",
    kind: "Professional",
    year: "2025",
    summary:
      "Work shown as decisions rather than as pictures. Every project says what the problem was and what changed, which is the only thing a prospective client is reading it for.",
    facts: [
      { term: "Pages", value: "16" },
      { term: "Built in", value: "7 weeks" },
      { term: "Visitors", value: "Clients and press" },
    ],
    image: "/work-shop.png",
    alt: "A project page opened on a case study.",
    tone: "#e8ebf0",
  },
  {
    id: "workshop",
    name: "A workshop that takes orders",
    kind: "Made to order",
    year: "2026",
    summary:
      "Nothing on the shelf and everything made to measure, so the site asks the four questions that turn an enquiry into a quotable job before anybody picks up a phone.",
    facts: [
      { term: "Pages", value: "10" },
      { term: "Built in", value: "5 weeks" },
      { term: "Visitors", value: "Trade and public" },
    ],
    image: "/work-shop.png",
    alt: "An enquiry page for made to order work.",
    tone: "#e9ebef",
  },
  {
    id: "school",
    name: "A school that fills its places",
    kind: "Admissions",
    year: "2025",
    summary:
      "Written for parents deciding in an evening: what it is like, what it costs, when the open day is, and how to register - each one page rather than one prospectus.",
    facts: [
      { term: "Pages", value: "18" },
      { term: "Built in", value: "8 weeks" },
      { term: "Visitors", value: "Parents and staff" },
    ],
    image: "/work-shop.png",
    alt: "An admissions page with the open day dates on it.",
    tone: "#eaedf1",
  },
  {
    id: "venue",
    name: "A venue that sells its dates",
    kind: "Events",
    year: "2026",
    summary:
      "Availability, capacity and what a room actually holds, in one place - so an enquiry arrives with the date already checked rather than as a question about one.",
    facts: [
      { term: "Pages", value: "12" },
      { term: "Built in", value: "6 weeks" },
      { term: "Visitors", value: "Organisers and guests" },
    ],
    image: "/work-shop.png",
    alt: "A venue page showing the dates still free.",
    tone: "#e7eaef",
  },
];
