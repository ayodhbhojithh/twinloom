    ...
    >
      <div className="flex flex-col gap-2">
        <input
          ...
          spellCheck={false}
          className="h-9 w-full rounded-btn-sm border border-line bg-card px-3 text-[12px] outline-none transition-colors placeholder:text-faint focus:border-brand"
        />
        ...
        <div className="flex gap-2">
          <input
            ...
            className="h-9 min-w-0 flex-1 rounded-btn-sm border border-line bg-card px-3 text-[12px] outline-none transition-colors placeholder:text-faint focus:border-brand"
          />
          <button
            type="button"
            onClick={submit}
      ...
      {links.length ? (
        <ul className="mt-3 flex flex-col gap-2">
          {links.map((link) => (
            <li
              key={link.id}
              className="group/link flex items-start gap-2 rounded-card border border-line bg-card p-3 transition-colors hover:border-brand/35"
            >
              <span
                aria-hidden
              ...
              <div className="min-w-0 flex-1">
                <a
                  ...
                  className="flex items-center gap-1 text-[12.5px] font-bold text-brand hover:underline"
                >
