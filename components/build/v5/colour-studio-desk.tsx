...
/* ---------------------------------------------------------------------------
   The colour studio itself.

   Split out of the panel that opens it, and for one reason: it is a thousand
   lines and it is a modal. Sitting in the same module as its trigger, every
   one of those lines - the eyedropper, the screen capture, the harmonies, the
   contrast maths, the whole picker - was in the first download of the build
   page, for a surface most people never open.

   It loads when it is opened. See `colour-studio.tsx`, which reaches it
   through `next/dynamic`, and nothing else imports this.
--------------------------------------------------------------------------- */
